...
public class RecordPointManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            RecordPointManager.playerRecordPos = new Vector3(-0.8f, 0f, -20f);
        }
        if (Input.GetKeyDown("2"))
        {
            RecordPointManager.playerRecordPos = new Vector3(29.9f, 0f, 7.63f);
        }
        if (Input.GetKeyDown("3"))
        {
            RecordPointManager.playerRecordPos = new Vector3(62.82f, 0f, 3.51f);
        }
    }
